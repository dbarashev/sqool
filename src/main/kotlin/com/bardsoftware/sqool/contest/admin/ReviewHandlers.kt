...
data class ReviewGetArgs(var user_id: String, var task_id: String, var reviewer_id: String) : RequestArgs()
...
data class ReviewSaveArgs(var user_id: String, var task_id: String, var reviewer_id: String, var solution_review: String) : RequestArgs()
